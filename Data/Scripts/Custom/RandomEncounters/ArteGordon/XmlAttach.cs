...
//				return;
       ...
       /* public static void CheckOnRemoved( Item item, object parent )
		...
		public static void UseReq( NetState state, PacketReader pvSrc )
		{
			...
			//if ( from.AccessLevel >= AccessLevel.GameMaster || Core.TickCount - from.NextActionTime >= 0 ) //Wazi - no idea what TickCount does or where it needs/should be declared/added
